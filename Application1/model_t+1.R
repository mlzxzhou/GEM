...
#### Load Data ####
data <- npyLoad("data/prediction/area5/t_1/data.npy")
y <- data[, 1]
xh1 <- data[, 2:11]
xh2 <- data[, 12:16]
xl1 <- data[, 17:26]
...
y_true = y[2161:3600]
print("t+10 All time RMSE of GEM:")
sqrt(mean((y_pred_g - log(y_true))^2)) #RMSE
print("t+10 All time MAPE of GEM:")
...
print("t+10 Peak hour RMSE of GEM:")
sqrt(mean((y_two[, 1] - log(y_two[, 2]))^2))
print("t+10 Peak hour MAPE of GEM:")
...
y_true = y[2161:3600]
print("t+10 All time hour RMSE of Hellinger:")
sqrt(mean((y_pred_h - log(y_true))^2)) #RMSE
print("t+10 All time MAPE of Hellinger:")
...
print("t+10 Peak hour RMSE of Hellinger:")
sqrt(mean((y_two[, 1] - log(y_two[, 2]))^2))
print("t+10 Peak hour MAPE of Hellinger:")
mean(abs(exp(y_two[, 1]) - y_two[, 2])/y_two[, 2])
...
y_true = y[2161:3600]
print("t+10 All time hour RMSE of L2:")
sqrt(mean((y_pred_l - log(y_true))^2)) #RMSE
print("t+10 All time MAPE of L2:")
...
print("t+10 Peak hour RMSE of L2:")
sqrt(mean((y_two[, 1] - log(y_two[, 2]))^2))
print("t+10 Peak hour MAPE of L2:")
mean(abs(exp(y_two[, 1]) - y_two[, 2]) / y_two[, 2])
...
y_true = y[2161:3600]
print("t+10 All time hour RMSE of Wasserstein:")
sqrt(mean((y_pred_w - log(y_true))^2)) #RMSE
print("t+10 All time MAPE of Wasserstein:")
...
print("t+10 Peak hour RMSE of Wasserstein:")
sqrt(mean((y_two[, 1] - log(y_two[, 2]))^2))
print("t+10 Peak hour MAPE of Wasserstein:")
mean(abs(exp(y_two[, 1]) - y_two[, 2])/y_two[, 2])
